...
public class VideoUploadService extends Service {
    ...
    private int positionVideoType = 1;
    private Thread thread;
    private int NOTIFICATION_ID = 106;
    private NotificationCompat.Builder builder;
    private NotificationManager notificationManager;
    private static final String CANCEL_TAG = "c_vu";
    private String NOTIFICATION_CHANNEL_ID = "upload_video";
    public static final String ACTION_STOP = "com.vu.action.STOP";
    public static final String ACTION_START = "com.vu.action.START";
    private String userId, catId, videoType, videoTitle, videoLocal, videoThumbnail, langIds, videoTags;
    ...
    public void onCreate() {
        ...
        Intent closeIntent = new Intent(this, VideoUploadService.class);
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent.getAction() != null && intent.getAction().equals(ACTION_START)) {
            ...
            videoType = intent.getStringExtra("video_layout");
            videoTitle = intent.getStringExtra("video_title");
            videoLocal = intent.getStringExtra("video_local");
            videoThumbnail = intent.getStringExtra("video_thumbnail");
            langIds = intent.getStringExtra("lang_ids");
            videoTags = intent.getStringExtra("video_tags");

            try {
                MediaMetadataRetriever metaRetriever = new MediaMetadataRetriever();
                metaRetriever.setDataSource(videoLocal);
                ...
                try {
                    ...
                    BitmapFactory.decodeFile(videoThumbnail, options);
                    ...
                    init();
                    Log.d("error_show", exception.toString());
                }
            }
    ...
    public void init() {
        thread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                File videoFile = new File(videoLocal);
                ...
                jsObj.addProperty("video_layout", videoType);
                jsObj.addProperty("user_id", userId);
                jsObj.addProperty("video_title", videoTitle);
                jsObj.addProperty("lang_ids", langIds);
                jsObj.addProperty("video_tags", videoTags);
